...
#subject to genQatbusdef{i in 1..I}:
#genQatbus[i] =  sum{g in gensatbusat0[i]: gencountat0[i]>0} genQ0[g]; buggy not 0
#genQatbus[i] =  sum{g in gensatbus[i]: gencount[i]>0} genQ0[g];
...
subject to QBalanceat0{i in 1..I}:
 genQatbus[i]
 - sum{l in activeloadsatbusat0[i]: activeloadcountat0[i]>0}loadQ0[l] - Qfsh[i]  - Qswsh[i]
